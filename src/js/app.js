...
function createSkillElement(skill) {
  ...
  skillDiv.innerHTML = `
    <p class="font-BoldFt text-base md:text-lg mr-2">${skill.name}</p>
    <div class="w-full h-4 md:h-5 rounded-full border border-orange-400">
      <div class="relative flex items-center progress-bar bg-orange-400 dark:bg-orange-800 h-full rounded-full" style="width: 0;">
        <p class="text-xs md:text-sm absolute left-1">${skill.percentage}%</p>
      </div>
    </div>
  `;
