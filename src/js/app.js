 ...
 `;
  ...
  .catch((error) => {
    document.querySelector(".project").innerHTML = `
      <p class="my-12 mx-2 text-lg md:text-xl text-center bg-gray-100 dark:bg-gray-900 shadow-normal dark:shadow-normaldark rounded-md p-3 md:p-6">مشکلی در بارگذاری پیس آمد، خطای (404).</p>
    `;
  });
...
fetch("./src/js/data.json")
  ...
  .catch((error) => console.log("Error Link Me (404)."));
