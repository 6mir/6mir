...
function createSkillElement(skill) {
  ...
  skillDiv.innerHTML = `
    <p class="font-BoldFt text-base md:text-lg line-clamp-none mr-2">${skill.name}</p>
    </div>
    <div class="w-full h-4 md:h-5 rounded-full overflow-hidden border border-orange-400">
      <div class="progress-bar relative flex items-center bg-orange-400 dark:bg-orange-800 h-full" style="width: 0;">
